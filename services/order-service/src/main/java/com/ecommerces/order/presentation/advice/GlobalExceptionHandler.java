package com.ecommerces.order.presentation.advice;
...
/**
 * Centralised exception handling for the Order Service REST layer.
 * Returns RFC 9457 {@link ProblemDetail} responses for clean, consistent error bodies.
 */
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles bean validation failures (e.g. missing required fields, invalid quantities).
    ...
    /**
     * Handles {@link ResponseStatusException} thrown by e.g. {@link com.ecommerces.order.infrastructure.http.InventoryClient}
